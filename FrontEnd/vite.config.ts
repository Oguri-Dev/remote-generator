...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/ws': { target: 'ws://localhost:8099', ws: true, changeOrigin: true },
      '/mqtt': { target: 'http://localhost:8099', changeOrigin: true },
      // si usas endpoints legacy como /mqtt/..., puedes agregar también:
    },
  },
  /**
