    ...
    <div class="navbar-menu" :class="[isMobileNavOpen && 'is-active']">
      <div class="navbar-start">
        <div class="navbar-item">
          <RouterLink to="/" class="nav-link" @click.passive="
            () => {
      ...
      <div class="navbar-end">
        <div class="navbar-item is-theme-toggle">
          <label class="theme-toggle">
            <input id="navbar-night-toggle--daynight" v-model="darkmode.isDark" data-cy="dark-mode-toggle"
              type="checkbox">
            <span class="toggler">
              <span class="dark">
          ...
          .theme-toggle {
            ...
            input {
              ...
              &:checked~.toggler {
                ...
                .dark,
                .light {
                  transform: translateX(calc(var(--transform-direction) * 100%)) rotate(calc(var(--transform-direction) * 360deg));
                }
